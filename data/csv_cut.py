...
CHOSEONG_TO_GROUP = {
    0: '가', 1: '가', 2: '나', 3: '다', 4: '다',
    5: '라', 6: '마', 7: '바', 8: '바', 9: '사',
    10: '사', 11: '아', 12: '자', 13: '자', 14: '차',
    15: '카', 16: '타', 17: '파', 18: '하'
}

# 21개 중성 → 10개 그룹
JUNGSEONG_TO_GROUP = {
    0: '아', 1: '아', 2: '야', 3: '여', 4: '어', 5: '어',
    6: '오', 7: '오', 8: '오', 9: '오', 10: '요',
    11: '우', 12: '우', 13: '우', 14: '우', 15: '유',
    16: '으', 17: '으', 18: '이', 19: '이', 20: '이'
}
...
def get_char_category(char):
    if char.isdigit():
        ...
        result = classify_korean_syllable(char)
        print(f"  🔍 '{char}' → {result}")
        return result
    else:
        return '_'
...
def split_csv():
    ...
    with open(INPUT_FILE, 'r', encoding=ENCODING) as infile:
        ...
        for row in reader:
            ...
            if total <= 5:  # 처음 5건만 디버깅
                print(f"  '{company_name}' → '{first_char}' → {file_name}")
    
    for f in output_files.values():
        f.close()
    
    print(f"\n✅ 완료! 총 {total:,}건")
    print(f"📁 파일: {len(output_files)}개")
